...
package net.fatcar.necrotuals.entity;
...
public class StubEntity extends PathfinderMob {
	public final AnimationState animationState0 = new AnimationState();

	public StubEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(NecrotualsModEntities.STUB.get(), world);
	}

	public StubEntity(EntityType<StubEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		super.registerGoals();
		this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<LivingEntity>(this, LivingEntity.class, 10, true, false, entity -> !(entity instanceof Player) && !(entity instanceof StubEntity)));
